...
try:
    from src.legacy.p1_features import (
        MultiGPUTrainer,
...
try:
    from src.legacy.p2_features import (
        DockerfileGenerator,
...
try:
    ...
    from src.legacy.models.legacy.neurosnake_model import NeuroSnakeModel
...
try:
    from src.legacy.data_preprocessing import create_data_generators
