...
- Adan optimizer (magnitude-sensitive) - **Upgraded for Keras 3**
...
- `one_click_train_test.py` - **Functional** automation script with data generators

### Training Infrastructure (`src/`)
- `phoenix_optimizer.py` - Adan optimizer (Keras 3 compatible), Focal Loss
...
### Entry Point
- `one_click_train_test.py` - Complete automation script (Training & Testing modes)
...
5. **Optimizer Choice Matters**: Medical imaging needs magnitude-sensitive optimization (Adan)
6. **Framework Evolution**: Keras 3 requires strict adherence to new Optimizer APIs (state variable management)
...
4. Study `src/phoenix_optimizer.py` to understand Keras 3 custom optimizers
