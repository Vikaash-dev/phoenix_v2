...
def train_model(args):
    ...
    # Physics-informed augmentation function wrapper
    def apply_physics_augmentation(image, label):
        def augment_fn(img):
            return augmentor.augment(img.numpy())
        ...
        augmented_image.set_shape([config.IMG_HEIGHT, config.IMG_WIDTH, 3])
    ...
    # Apply physics augmentation if available
