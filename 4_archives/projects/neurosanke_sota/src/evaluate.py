...
import config
from src.data_preprocessing import create_data_generators, load_dataset_from_directory, split_dataset
...
def evaluate_with_generator(model, test_generator):
    ...
    # Calculate Specificity (for binary/multiclass)
    # For multiclass, we calculate average specificity
